  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="relative mb-4 w-full max-w-3xl ">
        <div className="transform skew-x-12 bg-gray-700  flex h-16  items-center gap-5 w-full pe-5   ">
          <div className="w-1/12 h-16 -skew-x-12">
          ...
          <Image
            className="-skew-x-12 w-1/12 p-1 "
            src={'/images/profile.png'}
            alt="profile"
            width={20}
            height={20}
          />
          <div className="transform -skew-x-12 w-5/12 text-white  font-bold">
            {props.user.name}
          </div>
