...
import { basicAlgebraicQuestions } from './data';
...
const BasicAlgebraicConceptsAssessment = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            {basicAlgebraicQuestions[0].conceptReview && (
                <div className="prose max-w-none mb-6 bg-gray-900 text-blue-300 border border-blue-700 rounded p-4 shadow">
                    ...
                    <ul>
                        {basicAlgebraicQuestions[0].conceptReview.map((concept, index) => (
                            <li key={index}>
            ...
            {basicAlgebraicQuestions.map((question) => (
